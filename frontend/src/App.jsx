    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div id="about" className="bg-white rounded-2xl border border-gray-200 p-8 mt-10">
          <h2 className="text-lg font-bold text-gray-900 mb-1">About SkillMap</h2>
          ...
          <div className="flex flex-col gap-3 text-sm text-gray-600 leading-relaxed">
            <p>
              <b className="text-gray-800">SkillMap</b> is a smart resume analyzer built for students and freshers entering the job market.
            </p>
            <p>
            ...
            <p>
              SkillMap maps your current skills to real career paths — showing you exactly how ready you are for roles like Data Analyst, Full Stack Developer, ML Engineer, and more.
            </p>
            <p>
        ...
        <div id="help" className="bg-white rounded-2xl border border-gray-200 p-8 mt-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              <p className="text-sm font-medium text-gray-800 mb-2">How to use SkillMap</p>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
              ...
              <a
                href="mailto:vj3.mekhana@gmail.com?subject=SkillMap Feedback"
